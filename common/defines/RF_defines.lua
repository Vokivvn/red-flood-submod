...
NDefines.NDiplomacy.TENSION_ANNEX_NO_CLAIM = 2								-- Vanilla is 2
NDefines.NDiplomacy.TENSION_ANNEX_CLAIM = 1									-- Vanilla is 1
NDefines.NDiplomacy.TENSION_ANNEX_CORE = 0.5								  	-- Vanilla is 0.5
NDefines.NDiplomacy.TENSION_PUPPET = 2										-- Vanilla is 2
NDefines.NDiplomacy.TENSION_GENERATE_WARGOAL = 1							-- Vanilla is 1
NDefines.NDiplomacy.TENSION_VOLUNTEER_FORCE_DIVISION = 0.5					-- Vanilla is 0.5
NDefines.NDiplomacy.TENSION_DECAY = 0.1										-- Vanilla is 0.1
NDefines.NDiplomacy.TENSION_SIZE_FACTOR = 1									-- Vanilla is 1.0
